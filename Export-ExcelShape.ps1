...
<#
    ...
    .EXAMPLE
        .\Export-ExcelShape.ps1 -Path .\test.xlsx | Export-Csv -Path .\out.csv -Encoding UTF8 -NotypeInformation

        Export shapes in .\test.xlsx as CSV.

    .EXAMPLE
        Get-ChildItem -Filter *.xlsx | .\Export-ExcelShape.ps1 | Tee-Object -Variable out | Out-GridView
...
Begin {
    ...
    $MsoAutoShapeType = @{
        ...
        166 = 'msoShapeMathDivide' # Division symbol ÅÄ
        167 = 'msoShapeMathEqual' # Equivalence symbol =
        168 = 'msoShapeMathNotEqual' # Non-equivalence symbol ÅÇ
